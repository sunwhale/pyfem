...
from pyfem.isoelements.shape_functions import get_shape_line2, get_shape_tetra4_barycentric, get_shape_empty, get_shape_hex20, \
    get_shape_quad4, get_shape_tria3, get_shape_tria3_barycentric, get_shape_line3, get_shape_quad8, get_shape_tria6_barycentric, get_shape_hex8
...
if __name__ == "__main__":
    ...
    from pyfem.isoelements.IsoElementShape import iso_element_shape_dict as iso_element_shape_dict1
    ...
    for key in iso_element_shape_dict[geo_type].__slots_dict__:
        try:
            print(key)
            if isinstance(iso_element_shape_dict[geo_type].__getattribute__(key), dict):
                for subkey in iso_element_shape_dict[geo_type].__getattribute__(key):
                    print(subkey)
                    # print(iso_element_shape_dict[geo_type].__getattribute__(key)[subkey])
                    # print(iso_element_shape_dict1[geo_type].__getattribute__(key)[subkey])
                    print(iso_element_shape_dict[geo_type].__getattribute__(key)[subkey] - iso_element_shape_dict1[geo_type].__getattribute__(key)[subkey])
            print(iso_element_shape_dict[geo_type].__getattribute__(key) - iso_element_shape_dict1[geo_type].__getattribute__(key))
