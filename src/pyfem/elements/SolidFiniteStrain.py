...
class SolidFiniteStrain(BaseElement):
    ...
    **固体有限变形单元**
    ...
    __allowed_material_data_list__ = [('ElasticIsotropic', 'PlasticIsotropicHardening', 'PlasticKinematicHardening', 'PlasticCrystal', 'PlasticCrystalGNDs', 'ViscoElasticMaxwell', 'ViscoElasticPlasticMaxwell', 'User')]
