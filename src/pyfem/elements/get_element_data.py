...
ElementData = Union[
    BaseElement,
    SolidSmallStrain,
    SolidThermalSmallStrain,
    SolidPhaseDamageSmallStrain,
    SolidGradientPhaseDamageSmallStrain,
    SolidPhaseDamageDiffusionSmallStrain,
    SolidPhaseDamageThermalSmallStrain,
    SolidPhaseDamageCZMSmallStrain,
    Thermal,
    Diffusion,
    CohesiveZone,
    SurfaceEffect
