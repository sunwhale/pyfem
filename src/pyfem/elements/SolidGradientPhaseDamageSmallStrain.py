...
class SolidGradientPhaseDamageSmallStrain(BaseElement):
    r"""
    固体相场断裂单元。
    ...
    __allowed_material_data_list__ = [('ElasticIsotropic', 'PlasticKinematicHardening', 'ViscoElasticMaxwell', 'PlasticCrystal', 'PlasticCrystalGNDs', 'User'),
                                      ('PhaseFieldDamage', 'GradientPhaseFieldDamage', 'User')]
    ...
    def update_element_material_stiffness_fint(self,
        ...
        g1c = phase_material_data.g1c  # type: ignore
        g2c = phase_material_data.g2c  # type: ignore
